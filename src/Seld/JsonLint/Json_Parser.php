...
class Json_Parser
{
     ...
     */
    private $symbols = ['error' => 2, 'JSONString' => 3, 'STRING' => 4, 'JSONNumber' => 5, 'NUMBER' => 6, 'JSONNullLiteral' => 7, 'NULL' => 8, 'JSONBooleanLiteral' => 9, 'TRUE' => 10, 'FALSE' => 11, 'JSONText' => 12, 'JSONValue' => 13, 'EOF' => 14, 'JSONObject' => 15, 'JSONArray' => 16, '{' => 17, '}' => 18, 'JSONMemberList' => 19, 'JSONMember' => 20, ':' => 21, ',' => 22, '[' => 23, ']' => 24, 'JSONElementList' => 25, '$accept' => 0, '$end' => 1];
    /**
     * @phpstan-var array<int, string>
     * @const
     */
    private $terminals_ = [2 => 'error', 4 => 'STRING', 6 => 'NUMBER', 8 => 'NULL', 10 => 'TRUE', 11 => 'FALSE', 14 => 'EOF', 17 => '{', 18 => '}', 21 => ':', 22 => ',', 23 => '[', 24 => ']'];
    /**
     * @phpstan-var array<int<1,21>, array{int, int}>
     * @const
     */
    private $productions_ = [1 => [3, 1], 2 => [5, 1], 3 => [7, 1], 4 => [9, 1], 5 => [9, 1], 6 => [12, 2], 7 => [13, 1], 8 => [13, 1], 9 => [13, 1], 10 => [13, 1], 11 => [13, 1], 12 => [13, 1], 13 => [15, 2], 14 => [15, 3], 15 => [20, 3], 16 => [19, 1], 17 => [19, 3], 18 => [16, 2], 19 => [16, 3], 20 => [25, 1], 21 => [25, 3]];
    /**
     * @var array<int<0, 31>, array<int, array<int>|int>> List of stateID=>symbolID=>actionIDs|actionID
     * @const
     */
    private $table = [0 => [3 => 5, 4 => [1, 12], 5 => 6, 6 => [1, 13], 7 => 3, 8 => [1, 9], 9 => 4, 10 => [1, 10], 11 => [1, 11], 12 => 1, 13 => 2, 15 => 7, 16 => 8, 17 => [1, 14], 23 => [1, 15]], 1 => [1 => [3]], 2 => [14 => [1, 16]], 3 => [14 => [2, 7], 18 => [2, 7], 22 => [2, 7], 24 => [2, 7]], 4 => [14 => [2, 8], 18 => [2, 8], 22 => [2, 8], 24 => [2, 8]], 5 => [14 => [2, 9], 18 => [2, 9], 22 => [2, 9], 24 => [2, 9]], 6 => [14 => [2, 10], 18 => [2, 10], 22 => [2, 10], 24 => [2, 10]], 7 => [14 => [2, 11], 18 => [2, 11], 22 => [2, 11], 24 => [2, 11]], 8 => [14 => [2, 12], 18 => [2, 12], 22 => [2, 12], 24 => [2, 12]], 9 => [14 => [2, 3], 18 => [2, 3], 22 => [2, 3], 24 => [2, 3]], 10 => [14 => [2, 4], 18 => [2, 4], 22 => [2, 4], 24 => [2, 4]], 11 => [14 => [2, 5], 18 => [2, 5], 22 => [2, 5], 24 => [2, 5]], 12 => [14 => [2, 1], 18 => [2, 1], 21 => [2, 1], 22 => [2, 1], 24 => [2, 1]], 13 => [14 => [2, 2], 18 => [2, 2], 22 => [2, 2], 24 => [2, 2]], 14 => [3 => 20, 4 => [1, 12], 18 => [1, 17], 19 => 18, 20 => 19], 15 => [3 => 5, 4 => [1, 12], 5 => 6, 6 => [1, 13], 7 => 3, 8 => [1, 9], 9 => 4, 10 => [1, 10], 11 => [1, 11], 13 => 23, 15 => 7, 16 => 8, 17 => [1, 14], 23 => [1, 15], 24 => [1, 21], 25 => 22], 16 => [1 => [2, 6]], 17 => [14 => [2, 13], 18 => [2, 13], 22 => [2, 13], 24 => [2, 13]], 18 => [18 => [1, 24], 22 => [1, 25]], 19 => [18 => [2, 16], 22 => [2, 16]], 20 => [21 => [1, 26]], 21 => [14 => [2, 18], 18 => [2, 18], 22 => [2, 18], 24 => [2, 18]], 22 => [22 => [1, 28], 24 => [1, 27]], 23 => [22 => [2, 20], 24 => [2, 20]], 24 => [14 => [2, 14], 18 => [2, 14], 22 => [2, 14], 24 => [2, 14]], 25 => [3 => 20, 4 => [1, 12], 20 => 29], 26 => [3 => 5, 4 => [1, 12], 5 => 6, 6 => [1, 13], 7 => 3, 8 => [1, 9], 9 => 4, 10 => [1, 10], 11 => [1, 11], 13 => 30, 15 => 7, 16 => 8, 17 => [1, 14], 23 => [1, 15]], 27 => [14 => [2, 19], 18 => [2, 19], 22 => [2, 19], 24 => [2, 19]], 28 => [3 => 5, 4 => [1, 12], 5 => 6, 6 => [1, 13], 7 => 3, 8 => [1, 9], 9 => 4, 10 => [1, 10], 11 => [1, 11], 13 => 31, 15 => 7, 16 => 8, 17 => [1, 14], 23 => [1, 15]], 29 => [18 => [2, 17], 22 => [2, 17]], 30 => [18 => [2, 15], 22 => [2, 15]], 31 => [22 => [2, 21], 24 => [2, 21]]];
    /**
     * @var array{16: array{2, 6}}
     * @const
     */
    private $default_actions = [16 => [2, 6]];
    /**
    ...
    public function parse($input, $flags = 0)
    {
        ...
        while (true) {
            ...
            if (isset($this->default_actions[$state])) {
                $action = $this->default_actions[$state];
            } else {
                if ($symbol === null) {
            ...
            if (!$action || !$action[0]) {
                ...
                if (!$recovering) {
                    ...
                    if (\in_array("'STRING'", $expected) && \in_array(substr($this->lexer->match, 0, 1), ['"', "'"])) {
                        ...
                        } elseif (preg_match('{".+?(\\\\[^"bfnrt/\\\\u](...)?)}', $this->lexer->get_full_upcoming_input(), $match)) {
                            $message .= ', it appears you have an unescaped backslash at: ' . $match[1];
                        } elseif (preg_match('{"(?:[^"]+|\\\\")*$}m', $this->lexer->get_full_upcoming_input())) {
                            $message .= ', it appears you forgot to terminate a string, or attempted to write a multiline string which is invalid';
                        }
                    }
                    $err_str = 'Parse error on line ' . ($yylineno + 1) . ":\n";
                    $err_str .= $this->lexer->show_position() . "\n";
                    if ($message) {
                        $err_str .= $message;
                    } else {
                        $err_str .= \count($expected) > 1 ? 'Expected one of: ' : 'Expected: ';
                        $err_str .= implode(', ', $expected);
                    }
                    if (',' === substr(trim($this->lexer->get_past_input()), -1)) {
                        $err_str .= ' - It appears you have an extra trailing comma';
                    }
                    $this->parse_error($err_str, ['text' => $this->lexer->match, 'token' => isset($this->terminals_[$symbol]) ? $this->terminals_[$symbol] : $symbol, 'line' => $this->lexer->yylineno, 'loc' => $yyloc, 'expected' => $expected]);
                }
                // just recovered from another error
                if ($recovering == 3) {
                    if ($symbol === Lexer::EOF) {
                        throw new Parsing_Exception($err_str ?: 'Parsing halted.');
                    }
            ...
            if (\is_array($action[0]) && \count($action) > 1) {
                throw new Parsing_Exception('Parse Error: multiple actions possible at state: ' . $state . ', token: ' . $symbol);
            }
            switch ($action[0]) {
                case 1:
                    // shift
                ...
                case 2:
                    ...
                    $current_token = $this->vstack[\count($this->vstack) - $len];
                    // default to $$ = $1
                    ...
                    list($new_token, $action_result) = $this->perform_action($current_token, $yytext, $yylineno, $action[1]);
                    if (!$action_result instanceof Undefined) {
                    ...
                    $this->vstack[] = $new_token;
                    $this->lstack[] = $position;
                    /** @var int */
                    $new_state = $this->table[$this->stack[\count($this->stack) - 2]][$this->stack[\count($this->stack) - 1]];
                    $this->stack[] = $new_state;
                    break;
                case 3:
                    // accept
                    return true;
     ...
     * @return never
     */
    protected function parse_error($str, $hash = null)
    {
        throw new Parsing_Exception($str, $hash ?: []);
    }
    /**
     ...
     */
    private function perform_action($current_token, $yytext, $yylineno, $yystate)
    {
        $token = $current_token;
            ...
            case 17:
                ...
                if ($this->flags & self::PARSE_TO_ASSOC) {
                    ...
                    if ($this->flags & self::DETECT_KEY_CONFLICTS && isset($this->vstack[$len - 2][$key])) {
                        $err_str = 'Parse error on line ' . ($yylineno + 1) . ":\n";
                        $err_str .= $this->lexer->show_position() . "\n";
                        $err_str .= 'Duplicate key: ' . $this->vstack[$len][0];
                        throw new Duplicate_Key_Exception($err_str, $this->vstack[$len][0], ['line' => $yylineno + 1]);
                    }
                    if ($this->flags & self::ALLOW_DUPLICATE_KEYS && isset($this->vstack[$len - 2][$key])) {
                        $duplicate_count = 1;
                        do {
                            $duplicate_key = $key . '.' . $duplicate_count++;
                        } while (isset($this->vstack[$len - 2][$duplicate_key]));
                        $this->vstack[$len - 2][$duplicate_key] = $this->vstack[$len][1];
     ...
     * @return string
     */
    private function string_interpolation($match)
    {
        switch ($match[0]) {
            case '\\\\':
                return '\\';
     ...
     * @return void
     */
    private function fail_on_bom($input)
    {
        // UTF-8 ByteOrderMark sequence
        $bom = "﻿";
        if (substr($input, 0, 3) === $bom) {
            $this->parse_error('BOM detected, make sure your input does not include a Unicode Byte-Order-Mark');
        }
    }
}